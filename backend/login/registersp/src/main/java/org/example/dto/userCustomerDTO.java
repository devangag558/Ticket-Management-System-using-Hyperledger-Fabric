...
public class userCustomerDTO {
	...
	public userCustomer toEntity() {
        ...
        entity.setHash(passwordEncoder.encode(this.getPassword()));
        return entity;
    }
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		userCustomerDTO other = (userCustomerDTO) obj;
		return Objects.equals(email, other.email);
	}
	
	public userCustomerDTO(@Email(message = "Invalid email format") String email, @NotNull String name,

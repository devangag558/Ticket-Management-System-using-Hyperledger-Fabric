...
public class userSellerDTO {
	...
	public userSeller toEntity() {
        ...
        entity.setHashPassword(passwordEncoder.encode(this.getPassword()));
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		userSellerDTO other = (userSellerDTO) obj;
	...
	public userSellerDTO(String email, String name, String mobileNumber, String gstNumber, String address,
